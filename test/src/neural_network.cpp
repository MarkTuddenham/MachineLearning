...
TEST_CASE("Neural Network Activations", "[nn]")
{
  ...
  SECTION("Sigmoid")
  {
    ...
    Matrix m_b = NeuralNetwork::apply_activation(m_a, NeuralNetwork::Activation::Sigmoid);
  ...
  SECTION("FastSigmoid")
  {
    ...
    Matrix m_b = NeuralNetwork::apply_activation(m_a, NeuralNetwork::Activation::FastSigmoid);
  ...
  SECTION("TanH")
  {
    ...
    Matrix m_b = NeuralNetwork::apply_activation(m_a, NeuralNetwork::Activation::Tanh);
  ...
  {
    REQUIRE_THROWS(
        NeuralNetwork::apply_activation(m_a, static_cast<Teslyn::NeuralNetwork::Activation>(-1)));
  }
}
